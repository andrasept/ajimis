    ...
    Route::group(['middleware' => ['auth', 'permission']], function() { 
      Route::group(['prefix' => 'delivery'], function() {
        ...
        Route::group(['middleware' => ['role:delivery.superadmin']], function () {
          ...
          Route::get('/layout_area/default', 'DeliveryLayoutAreaController@set_default')->name('delivery.layout_area.default')->middleware('auth');
        ...
        // dashboard 
          ...
          Route::get('/dashboard_all', 'DeliveryDashboardController@all')->name('delivery.all.graph')->middleware('auth');
