	...
	<div class="col-lg-12">
		<div class="ibox ">
			...
			<div class="ibox-content">
				<form method="POST" action="{{ route('quality.area.update', $QualityArea->id) }}">
					@method('patch')
                	@csrf
					<div class="form-group  row"><label class="col-sm-2 col-form-label">Nama</label>
						<div class="col-sm-10"><input type="text" name="name" class="form-control" value="{{$QualityArea->name}}" required></div>
					</div>
					<div class="hr-line-dashed"></div>
					<div class="form-group  row"><label class="col-sm-2 col-form-label">Keterangan</label>
						<div class="col-sm-10"><input type="text" name="description" class="form-control" value="{{$QualityArea->description}}"></div>
					</div>
					<div class="hr-line-dashed"></div>
