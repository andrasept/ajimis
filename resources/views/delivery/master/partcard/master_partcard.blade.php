...
<div class="ibox" >
  <div class="ibox-title">
      <h4>Data Part Card</h4>
  </div>
  <div class="ibox-content" >
      <h5>Import Data</h5>
    <form action="{{route('delivery.master.master_partcard.import')}}"  method="POST"  enctype="multipart/form-data">
        @csrf
    ...
    <div class="row mb-3">
          ...
          <div class="col-lg-12 text-right">
           <a class="btn btn-primary  m-4 text-center" href="{{route('delivery.master.master_partcard.create')}}">Create</a>
          </div>
    </div>
    ...
    <script>
      ...
      $(document).ready(function() {
          ...
          var table = $('#master').DataTable( {
              ...
              "filter":true,
              "ajax": {
                          "url": "{{route('delivery.master.master_partcard')}}",
                          "data":function (d) {
                          // d.min = $('#min').val();
                          // d.max = $('#max').val();
              ...
              "columns": [
                  ...
                  { data: "remark_1", className: 'dt-body-center'},
                  { data: "remark_2", className: 'dt-body-center'},
                ],
              "columnDefs": [ {
                  "searchable": true,
                  "orderable": true,
