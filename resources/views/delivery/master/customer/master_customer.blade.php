...
<div class="ibox" >
  ...
  <div class="ibox-content" >
      <h5>Import Data</h5>
    <form action="{{route('delivery.master.master_customer.import')}}"  method="POST"  enctype="multipart/form-data">
        @csrf
    ...
    <div class="row mb-3">
          ...
          <div class="col-lg-12 text-right">
           <a class="btn btn-primary  m-4 text-center" href="{{route('delivery.master.master_customer.create')}}">Create</a>
          </div>
    </div>
    ...
    <script>
      ...
      $(document).ready(function() {
          ...
          var table = $('#master').DataTable( {
              ...
              "filter":true,
              "ajax": {
                          "url": "{{route('delivery.master.master_customer')}}",
                          "data":function (d) {
                          // d.min = $('#min').val();
                          // d.max = $('#max').val();
              ...
              "columns": [
                  ...
                  { data: "id", className: 'dt-body-center',
                      "render": function ( data, type, row ) {
                            return "<div class='btn-group'><a href='{{URL::to('/')}}/delivery/master-customer/"+data+"/edit' class='btn btn-xs btn-default'><i class='fa fa-pencil'></i></a><a onClick='return confirm("+'"are you sure  ?"'+")' href='{{URL::to('/')}}/delivery/master-customer/"+data+"/delete' class='btn btn-xs btn-danger'><i class='fa fa-trash'></i></a></div>";
                        },
                  },
                  { data: "customer_code", className: 'dt-body-center'},
